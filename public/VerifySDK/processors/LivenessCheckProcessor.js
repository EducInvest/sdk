...
export class LivenessCheckProcessor {
  ...
  processSessionResultWhileFaceTecSDKWaits = async (sessionResult, faceScanResultCallback) => {
    ...
    const url = `${VerifySDK.InitialConfigurations.BaseURL}/api/v1/verifications/${this.verification.getVerificationId()}/products/identity-verification/liveness-check`;
  ...
  onFaceTecSDKCompletelyDone = () => {
    ...
    if (this.success) {
      console.log("Liveness Confirmado");
    }
  };
